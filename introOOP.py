...
persona1 = Persona("Juan", 15, "Masculino", "Estudiente")
persona2 = Persona("Victor", 45, "Masculino", "Maestro")
persona3 = Persona("Laura", 24, "Femenino", "Estudante")

# Usar los métodos de la clase
print("\n")
persona1.presentarse()
persona1.cumplir_anios()
persona1.cambiar_ocupacion("Estudiante")
...
persona3.cambiar_ocupacion("Estudiante")
